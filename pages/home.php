        ...
        <div class="grid place-items-center text-wrap bg-white dark:bg-slate-900 bg-opacity-75 dark:bg-opacity-75 p-8 rounded-lg shadow-lg">
            <header class="text-center">
                <div class="flex items-center gap-x-fixed-md justify-center">
                    <h1 class="text-blue-600 text-2xl">Welcome to Our Website</h1>
                </div>
            ...
            <button onclick="go()" class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 my-8">
                Go Now ->
            </button>
